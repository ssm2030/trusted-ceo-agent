import type { PendingAction, ProviderSnapshot } from "@/features/analysis/analysis-provider";
...
export const PENDING_ACTION_LABELS: Readonly<Record<PendingAction, string>> = Object.freeze({
  human_response: "사람 확인 응답",
  terminal_approval: "저장된 승인",
