...
7. Use `approval-request --gate diagnostic`. Run approved deep work only with `run-components`, `prepare-jobs --stage deep_dive`, `ingest-result`, and `reduce-stage --stage deep_dive`.
